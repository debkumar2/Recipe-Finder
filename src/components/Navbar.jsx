...
const Navbar = () => {
  ...
  return (
    <div className="sticky top-0 left-0 w-full z-50 bg-white text-black shadow-sm">
      {/* Main Navbar Bar */}
      <div className="px-6 md:px-14 py-4 flex items-center justify-between relative bg-white z-50">
      ...
      <div 
        className={`lg:hidden absolute top-full left-0 w-full bg-white border-t border-gray-100 shadow-xl py-6 px-6 flex flex-col gap-6 z-40 max-h-[calc(100vh-70px)] overflow-y-auto transition-all duration-300 ease-in-out ${
          isMobileMenuOpen 
