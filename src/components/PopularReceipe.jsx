...
const PopularReceipe = () => {
    ...
    return (
        <div className="w-full px-6 md:px-14 lg:px-20 py-16 bg-gray-50/50">
            {/* Header section */}
            <div className="flex justify-between items-end mb-10">
                <div>
                    <h2 className="text-3xl md:text-4xl font-black text-gray-900 tracking-tight">Trending Now</h2>
                    <p className="text-gray-500 mt-2 font-medium">The most loved recipes this week</p>
                </div>
                <a href="#" className="hidden sm:flex items-center text-red-500 hover:text-red-600 font-bold text-sm md:text-base transition-colors bg-red-50 hover:bg-red-100 px-6 py-2.5 rounded-full">
            ...
            <a href="#" className="mt-8 flex sm:hidden items-center justify-center w-full text-red-500 font-bold text-base bg-red-50 py-3.5 rounded-2xl transition-colors hover:bg-red-100">
                View all recipes <ArrowRight size={18} className="ml-2" />
            </a>
        </div>
    );
